...
const Resume = () => {
  ...
  return (
    <div
      className="container p-5 bg-dark text-white"
      style={{
        borderRadius: '8px',
        fontFamily: 'Poppins, sans-serif',
        background: 'radial-gradient(circle, rgba(254,254,254,1) 6%, rgba(255,255,255,1) 10%, rgba(195,195,195,1) 36%, rgba(183,187,189,1) 48%, rgba(179,184,187,1) 64%, rgba(255,255,255,1) 92%)'
      }}
      id="resume"
    >
      <motion.h1

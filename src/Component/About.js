...
const About = () => {
    ...
    >
            ...
            <motion.p 
                ...
                style={{fontSize: 24, textAlign: 'center', fontFamily: 'serif', fontWeight: 700, fontStyle: 'italic'}}
            >
            ...
            <div className="row" style={{marginTop:-75}}>
                <div className="col-md-6 d-flex align-items-center justify-content-center">
                    <img src="./img/portfolio/vineeth_1.jpg" alt="About Me" className="img-fluid rounded-circle h-75" />
                </div>
                <div className="col-md-6 d-flex flex-column justify-content-center">
                    ...
                    <motion.p 
                        ...
                        style={{fontSize: 20, textAlign: 'justify', fontWeight: 500, fontStyle: 'italic', lineHeight: 2}}
                    >

...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setTimeout(() => setIsContentHidden(false), 500); // Duration should match your CSS transition
    };
    ...
    const handleClick = () => {
      ...
      if (mainContent) {
        ...
        setTimeout(() => mainContent.classList.remove('clickable'), 300); // Match the duration of the animation
      }
    };
